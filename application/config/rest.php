...
$vars->load_vars(APPPATH.'cfg/rest.cfg');
/*
|--------------------------------------------------------------------------
| HTTP protocol
|--------------------------------------------------------------------------
...
|
*/
$config['rest_auth'] = ($vars->cfg['rest_auth'])?$vars->cfg['rest_auth']:FALSE;
/*
|--------------------------------------------------------------------------
| REST Login Source
|--------------------------------------------------------------------------
...
|
*/
$config['auth_source'] = ($vars->cfg['rest_auth_source'])?$vars->cfg['rest_auth_source']:'';
/*
|--------------------------------------------------------------------------
...
$config['rest_valid_logins'] = array(
								($vars->cfg['rest_user'])?$vars->cfg['rest_user']:'' 
								=> 
								($vars->cfg['rest_pass'])?$vars->cfg['rest_pass']:''
								);
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_database_group'] = ($vars->cfg['rest_db_group'])?$vars->cfg['rest_db_group']:'default';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_keys_table'] = $vars->cfg['rest_prefix_tbl'].'keys';
/*
|--------------------------------------------------------------------------
| REST Enable Keys
|--------------------------------------------------------------------------
...
|
*/
$config['rest_logs_table'] = $vars->cfg['rest_prefix_tbl'].'logs';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_access_table'] = $vars->cfg['rest_prefix_tbl'].'access';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['rest_limits_table'] = $vars->cfg['rest_prefix_tbl'].'limits';
/*
|--------------------------------------------------------------------------
